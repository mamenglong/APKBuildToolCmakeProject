...
# instance fields
.field private a:Landroidx/appcompat/widget/H;
...
.method public static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 7
    :try_start_0
    invoke-static {p0, p1}, Landroidx/appcompat/widget/H;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method static a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/P;[I)V
    ...
    .line 6
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/H;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/P;[I)V
...
.method public static declared-synchronized c()V
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/g;->a:Landroidx/appcompat/widget/H;

    .line 4
    sget-object v1, Landroidx/appcompat/widget/g;->c:Landroidx/appcompat/widget/g;

    iget-object v1, v1, Landroidx/appcompat/widget/g;->a:Landroidx/appcompat/widget/H;

    new-instance v2, Landroidx/appcompat/widget/g$a;

    invoke-direct {v2}, Landroidx/appcompat/widget/g$a;-><init>()V

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/H;->a(Landroidx/appcompat/widget/H$e;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/H;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/H;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/H;->a(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/H;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
